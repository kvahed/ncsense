...
inline double cabs  (double d) {return std::fabs(d);}
inline float  cabs  (float  f) {return std::fabs(f);}
inline short  cabs  (short  s) {return std::fabs((float)s);}
inline long   cabs  (long   l) {return std::fabs((float)l);}
